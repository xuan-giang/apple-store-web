...
<div class="head-title">
    <h1 class="text-center m-0 p-0">Order Confirmation</h1>
</div>
<div class="add-detail mt-10">
    <div class="w-50 float-left mt-10">
        Hi {{$order->fullname}}, you order successfully!
        ...
        <table border="1" width="80%" style="margin: auto" >
            ...
            @foreach($list_products as $product)
                <tr>
                    ...
                    <td align="center">
                        <h5><span >{{$product->qty}}</span></h5>

                    </td>

                    <td align="center">
                        <div><h5><span >{{$product->qty * $product->price}}</span></h5></div>
